      ...
      <?php foreach($items as $new){ ?>
        ...
        <div class="news-item row">
          <div class="col-xs-2 img">
            <a  href="<?=site_url("records/seminar/view/".$new->id)?>"><img style='width:100%;' alt="<?=h($new->title)?> 照片" src="<?=_get_news_image_url($new->img_url)?>" /></a>
          </div>
          <div class="col-xs-10 content-container">
            <div class="title" ><a  href="<?=site_url("records/seminar/view/".$new->id)?>"><?=h($new->title)?></a>
