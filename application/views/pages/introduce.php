    ...
    <div class="col-md-12 col-sm-12">
      ...
      <div class="row">
        <div class="col-md-6  col-xs-12" style='padding-left: 0;padding-right: 0;'>
          <div style="padding-bottom:42px;" class="introduce-block introduce-define">
            <h2>參與式預算定義</h2>
            <p>參與式預算是指由人民來決定一部份公共預算的支出。民眾和社區內所有群體的代表，共同討論預算計畫，提出方案，並且投票決定支出的優先順序，取得「公共性」與「急迫性」兩者的平衡。</p>
            <p>
            參與式預算結合「參與式民主」（participatory democracy）的精神與「審議式民主」（deliberative democracy）的討論模式，相信「社區居民才是在地的專家」，藉由公民社會與公部門的集思廣益與集體合作的過程，改善現行政策尚未解決的公共問題，以及將公民社會的創意導入公部門，補足現行代議民主體制下的不足。</p>
          </div>
        </div>
      ...
      <div class="row">
        <div style='background: #f0ffec;' class="introduce-block col-md-8">
          ...
          <p>
          1996年，聯合國人居署（UN-Habitat）在伊斯坦堡會議上認可參與式預算是「善治的最佳實踐」（the best practice of good governance）。參與式預算從南美洲一路擴散到歐洲、亞洲、非洲與北美洲，造就近代的民主奇蹟！</p>
          <p>
          這套民主治理的實驗，近幾年成為不同的國家作為城市治理的參考模式。根據法國巴黎第八大學政治學教授辛特默（Yves Sintomer）等主編的參與式預算全球報告，在2010年，世界上參與式預算就已高達1,500件。在2013年版的報告書中，參與式預算的案例數統計更接近2,800件，三年內成長87%。而這股這股風潮也在2014年九合一大選期間吹到了臺灣政壇。</p> 
        </div>
