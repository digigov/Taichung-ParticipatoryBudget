    ...
    <div class="col-md-12 col-sm-12">
      ...
      <div class="row">
        <div class="introduce-block col-md-12">
          <h2>參與式預算源起</h2>
          <p>參與式預算源起於巴西愉港市（Porte Alegre）。1988年，巴西左派政權工人黨贏得愉港 市的大選，在第三波民主化的浪潮下標榜以「人民議會」進行都市治理，進行一系列的行政 改革，而參與式預算便在此脈絡下於1989年正式誕生。</p>
          <p>
          1996年，聯合國人居署（UN-Habitat）在伊斯坦堡會議上認可參與式預算是「善治的最 佳實踐」（the best practice of good governance）。參與式預算從南美洲一路擴散到歐洲、亞 洲、非洲與北美洲，造就近代的民主奇蹟！</p>
          <p>
          這套民主治理的實驗，近幾年成為不同的國家作為城市治理的參考模式。根據法國巴黎 第八大學政治學教授辛特默（Yves Sintomer）等主編的參與式預算全球報告，在2010年，世 界上參與式預算就已高達1,500件。在2013年版的報告書中，參與式預算的案例數統計更接 近2,800件，三年內成長87%。而這股這股風潮也在2014年九合一大選期間吹到了臺灣政壇。</p> 
        </div>
      </div>
      <div class="row">
        <div class="introduce-block col-md-12">
          <h2>參與式預算四大原則</h2>
          <p>政治學者溫普勒（Brian Wampler）指出，在巴西愉港，7成以上的參與者都屬於容易被 傳統政治參與管道排除的弱勢民眾。研究也發現，由於人都具有同理心，藉由審議程序的連 結，在更具包容性的公共討論下，人們會願意將公共資源優先挹注到最為迫切的公共需求， 捲動公眾參與公共資源的重分配（redistribution），推動實現社會正義的目標。</p>
          <p>參與式預算作為一種參與式民主之所以能夠誘發改變社會的可能性，來自於制度設計的 四大原則（Wampler 2012）
          </p> </div>
      </div>
