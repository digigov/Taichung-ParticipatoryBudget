...
class Servant extends MY_ADMIN_Controller {

  var $_view_root = "servant";
  var $fields = ["year","area_id","title", "record_date", "location", 
       "status", "content"];
  ...
  public function __construct()
  {
    ...
    $this->load->database();
    $this->load->model("servantModel");

    $this->_model = $this->servantModel;
    $this->load->vars([
      "_name" => $this->_name,
