...
class Hosttrain extends MY_Record_Controller {

  var $_view_root = "hosttrain";
  var $_name = "審議主持人培訓";
  ...
  public function view($view_id){
    ...
    $this->load->view("records/".$this->_view_root."/view",[
        "pageTitle" => _date_format_utc($item->record_date,"Y-m-d")." 訪談 ".$item->interviewer." | ".$year." ".$this->_name,
        "breadcrumb" => $breadcrumb,
        "record" => $record,
        "item" => $item,
        "images" => $images
